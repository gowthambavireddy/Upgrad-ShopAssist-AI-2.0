...
def invite():
    ...
    prompt = ('Remember that you are a intelligent laptop shopping assistant. You should help and answer only with the '
              'queries related to laptops. If the queries are not related to laptops, just say something like '
              'you can help only with queries related to laptops etc.')
    ...
    if top_3_laptops is None:
        ...
        if "No" in confirmation.get('result'):
            ...
            print("WAIT")
            conversation_bot.append(
                {'bot': "Thank you for providing all the information. Kindly wait, while I fetch the products: \n"})
